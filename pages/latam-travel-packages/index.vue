<template>
  <header class="h-[75vh] relative">
    <img src="/images/banners/Cusco-MachuPicchu-Classic-Program.jpg" alt="" class="object-cover w-screen h-full">
  ...
  <section class="my-12">
    <div class="container my-6">
      <div class="grid text-center text-lg">
        <p>Nuestros paquetes más solicitados en Perú son solo el comienzo. En HAPPYLLAMAS, nos dedicamos a crear experiencias únicas adaptadas a tus gustos. Te invitamos a explorar estos itinerarios para inspirarte y descubrir algunos de los destinos más emblemáticos, como Machu Picchu, el Lago Titicaca, Nazca y la Amazonía.</p>
      </div>
    </div>
