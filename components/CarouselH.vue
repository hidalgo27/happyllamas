  ...
  <div class="container">
    <div class="grid grid-cols-7">
      <div class="col-span-7 md:col-span-2">
        <h2 class="text-3xl font-bold mt-12 md:mt-0 hidden md:block">Lo Mejor de Perú</h2>
        <p class="my-6 hidden md:block">Presentamos una selección<br>
          de los mejores paquetes de viaje, <br>
          combinando destinos excepcionales <br>
          dentro del país.</p>
